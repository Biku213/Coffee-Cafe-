...
class Cream1 extends StatefulWidget {
  @override
  State<Cream1> createState() => _Cream1State();
}

class _Cream1State extends State<Cream1> {
                ...
                child: Container(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      Text(
                        "Starbucks whipped cream recipe itself is really simple. The only two ingredients you need to make whipped cream like Starbucks are heavy whipping cream and vanilla syrup.",
