...
class Cold6 extends StatefulWidget {
  @override
  State<Cold6> createState() => _Cold6State();
}

class _Cold6State extends State<Cold6> {
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      ListTile(
                        ...
                        onTap: () {
                          Favorite(
                            name: 'Ice and Caramel mixed Coffee',
                      ...
                      Text(
                        "Brew your espresso and let it cool to room temperature or cool it down in an ice bath. ... In a blender, add the ice, espresso, caramel sauce, ...",
